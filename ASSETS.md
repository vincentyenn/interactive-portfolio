...
This room was modeled and arranged for this portfolio. Architecture, stairs, desks, monitor, headphones, camcorder, blueprint layouts, signs, and screen artwork were authored for this project in Blender/Python. The `.blend` source and scripts are included so the scene can be changed without treating the GLB as a black box.
